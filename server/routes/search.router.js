...
router.get(
  '/typeId=:typeID/featureId=:featureID/searchTerm=:searchTerm',
  rejectUnauthenticated,
  (req, res) => {
  ...
  "vendors"."companyName";`;
      ...
      pool
        ...
        .catch((err) => {
          console.error(
            'SERVER - for NO type, feature, nor search term an error occurred:',
            err
          );
          res.sendStatus(500);
        });
    ...
    // If special feature and search term given but no vendor type:
      ...
      pool
        ...
        .catch((err) => {
          console.error(
            'Feature and Search - an error occurred getting filter results',
            err
          );
          res.sendStatus(500);
        });
